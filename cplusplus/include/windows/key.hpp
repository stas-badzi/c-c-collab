...
struct Key {
    enum class Enum : unsigned short {
        ...
        KPENTER = 701, /* Numpad Enter */
        KPCOMMA , /* Numpad , */
        KPDOT = VK_DECIMAL, /* Numpad . */
        KPPLUSMINUS = 702, /* Numpad ± */
        KPPARENL , /* Numpad ( */
        KPPARENR , /* Numpad ) */
        ...
        EISU = 851, /* Eisu (on JIS keyboards) */
        FN , /* Function key */
    };
