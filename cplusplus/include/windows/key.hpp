...
struct Key {
    enum class Enum : unsigned short {
        ...
        LESS = 295, /* < (on us keybards)(i think) */
        EQUAL , /* , */
        GREATER , /* > */
        QUESTION , /* ? */
        AT , /* @ */
        ...
        KPENTER = 669, /* Numpad Enter */
        KPCOMMA , /* Numpad , */
        KPDOT = VK_DECIMAL, /* Numpad . */
        KPPLUSMINUS = 670, /* Numpad ± */
        KPPARENL , /* Numpad ( */
        KPPARENR , /* Numpad ) */
