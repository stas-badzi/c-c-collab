...
ifeq ($(shell uname -s),Darwin)
#macos
	@cd cplusplus && $(compiler) -dynamiclib -o bin/lib$(name).dylib $(objects) -L$(flibdir) $(flib) $(ldarg)
#
else
#linux and similar
	@cd cplusplus && $(compiler) -shared -o bin/lib$(name).so $(objects) -L$(flibdir) $(flib) $(ldarg)
endif
endif
endif
endif
